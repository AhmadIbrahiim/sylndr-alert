...
const STRINGS = {
  ...
  "stat.avgMargin": { en: "Avg vs market", ar: "متوسط فوق سعر السوق" },
  ...
  "featured.tag.highMargin": { en: "above market", ar: "فوق سعر السوق" },
  ...
  "filter.sort.marginDesc": { en: "Biggest premium over market", ar: "الأعلى فوق سعر السوق" },
  "filter.sort.marginAsc": { en: "Smallest premium over market", ar: "الأقل فوق سعر السوق" },
  ...
  "card.priceLadder.market": { en: "Market", ar: "سعر السوق" },
  "card.priceLadder.market.tooltip": { en: "Sylndr's market price estimate: {amount} EGP", ar: "تقدير سيلندر لسعر السوق: {amount} جنيه" },
  "card.priceLadder.premium": { en: "{pct}% vs market", ar: "{pct}٪ فوق السوق" },
  ...
  "detail.ladder.market": { en: "Market price", ar: "سعر السوق" },
  "detail.ladder.market.note": { en: "Sylndr's market-price estimate", ar: "تقدير سيلندر لسعر السوق" },
  ...
  "detail.premium.atMarket": { en: "0% (at market)", ar: "٠٪ (مع سعر السوق)" },
  "detail.premium.bigPremium": { en: "50%+ (big premium)", ar: "٥٠٪+ (علاوة كبيرة)" },
  "detail.premium.label": { en: "+{pct}% over market · {abs} EGP", ar: "+{pct}٪ فوق سعر السوق · {abs} جنيه" },
  "detail.premium.labelUnder": { en: "−{pct}% under market · {abs} EGP saved", ar: "−{pct}٪ تحت سعر السوق · {abs} جنيه فرق" },
  ...
  "bullet.marginLow": {
    en: "Retail is close to (or under) Sylndr's market-price estimate — no big premium baked in.",
    ar: "السعر المعروض قريب من تقدير سيلندر لسعر السوق — مفيش علاوة كبيرة فوقه.",
  },
  "bullet.marginHigh": {
    en: "Retail sits well above Sylndr's market-price estimate — buyer is paying a real premium.",
    ar: "السعر المعروض أعلى بكتير من تقدير سيلندر لسعر السوق — المشتري بيدفع علاوة محسوسة.",
  },
  "bullet.marginMid": {
    en: "Retail is a moderate premium over Sylndr's market-price estimate.",
    ar: "السعر المعروض فيه علاوة متوسطة فوق تقدير السوق.",
  },
  "bullet.auctionHot": {
  ...
  "summary.suffix.marginLow": { en: ", priced close to market", ar: "، سعرها قريب من السوق" },
  "summary.suffix.marginHigh": { en: ", priced well above market", ar: "، سعرها أعلى بكتير من السوق" },
  "summary.template": {
